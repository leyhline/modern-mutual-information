function result = shiftmiDoubleWrapper( x, y, varargin )
%   SHIFTMIDOUBLEWRAPPER Easier interface to calculating shifted mutual in parallel.
%   SHIFTMIDOUBLEWRAPPER(x, y) shifts data vectors and calculates mutual
...
result = shiftmiDouble(shiftRange, binSizes, minmaxOfData, x, y, shiftSteps);
end
